...
const ThreeJSComponent = () => {
  ...
  useEffect(() => {
    let renderer: THREE.WebGLRenderer,
      ...
      stats: any;
    let pointclouds: THREE.Points[]; // Cambiado de `any` a `THREE.Points[]`
    ...
    const spheres: THREE.Mesh[] = []; // Cambiado de `any` a `THREE.Mesh[]`
    ...
    // Agregar el punto de nube a la escena
    ...
    // Crear las esferas para mostrar las intersecciones
  ...
  return (
    <div>
      <div ref={containerRef} style={{ width: "50%", height: "50vh" }} />
      <div id="info">
        <a
